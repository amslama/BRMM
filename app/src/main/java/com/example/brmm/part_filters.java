...
public class part_filters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apply_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ArrayList<Rentable> parts = filterParts(null, name, sn, cost);
    ...
    public   ArrayList<Rentable> filterParts(ArrayList<Rentable> aList, String name, int sn, double cost) {
        ArrayList<Rentable> filter = aList;
        if (!name.equals(""))
    ...
    public ArrayList<Rentable> filterByName(ArrayList<Rentable> parts, String name) {
        ArrayList<Rentable> filter = new ArrayList<>();
        for (Rentable aPart: parts) {
    ...
    public ArrayList<Rentable> filterBySn(ArrayList<Rentable> parts, int sn) {
        ArrayList<Rentable> filter = new ArrayList<>();
        for (Rentable aPart: parts) {
    ...
    public ArrayList<Rentable> filterByCost(ArrayList<Rentable> parts, double cost) {
        ArrayList<Rentable> filter = new ArrayList<>();
        for (Rentable aPart: parts) {
