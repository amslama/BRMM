...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.memberViewHolder> {
    ...
    public RecyclerAdapter(ArrayList<BandMember> modelList) {
    ...
    public memberViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View contactView = inflater.inflate(R.layout.main_item_list_rview, parent, false);

        // Return a new holder instance
        memberViewHolder viewHolder = new memberViewHolder(contactView);
        return viewHolder;
    }
    ...
    //    type_textview.setText(member.getType());
        UID_textview.setText(member.getUID());
      //  section_textview.setText(member.getSection());
    //    instrument_textview.setText(member.getInstrument());

    //    holder.textView.setText(member.getID());
    //    holder.view.setBackgroundColor(member.isSelected() ? Color.CYAN : Color.WHITE);
        holder.fname_textview.setOnClickListener(new View.OnClickListener() {
            @Override
